const DefaultHead = () => {
  return (
    <>
      ...
      <meta name="application-name" content="DON TELMO WEB INVASION EXP." />
      ...
      <meta name="apple-mobile-web-app-status-bar" content="#fdd600" />
      ...
      />
      <link rel="apple-touch-icon" href="/manifest-logo/logo-192x192.png" />
      <link
